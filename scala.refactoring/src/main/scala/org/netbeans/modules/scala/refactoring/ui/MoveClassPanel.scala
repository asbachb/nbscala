 ...
 */
class MoveClassPanel(parent: ChangeListener, startPackage: String, headLine: String, fo: FileObject) extends JPanel with ActionListener with DocumentListener with CustomRefactoringPanel {
