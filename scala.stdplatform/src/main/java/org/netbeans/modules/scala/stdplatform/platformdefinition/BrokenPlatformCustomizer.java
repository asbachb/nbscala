...
public class BrokenPlatformCustomizer extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/scala/stdplatform/platformdefinition/Bundle").getString("MNE_PlatformName").charAt(0));
        jLabel1.setLabelFor(platformName);
        jLabel1.setText(java.util.ResourceBundle.getBundle("org/netbeans/modules/scala/stdplatform/platformdefinition/Bundle").getString("CTL_PlatformName"));
        ...
        jLabel2.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/scala/stdplatform/platformdefinition/Bundle").getString("MNE_PlatformHome").charAt(0));
        jLabel2.setLabelFor(platformHome);
        jLabel2.setText(java.util.ResourceBundle.getBundle("org/netbeans/modules/scala/stdplatform/platformdefinition/Bundle").getString("CTL_PlatformHome"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
